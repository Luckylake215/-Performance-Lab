# Задания Performance Lab

Задачи реализованы на Python.

## Структура репозитория

Репозиторий организован следующим образом:

- `author.txt`: Файл, содержащий имя автора и язык программирования, на котором выполнены задачи.

- `task1/`: Папка с решением для Задания 1.
  Файл: task1.py.

- ` task2/`: Папка с решением для Задания 2.
  Файл: task2.py.

- `task3/`: Папка с решением для Задания 3.
  Файл: task3.py.

- `task4/`: Папка с решением для Задания 4.
  Файл: task4.py.

Примечание: В каждой папке должен находиться только один файл с исходным кодом программы. Имена файлов должны иметь соответствующее расширение: .py.
...
●	Python; 
●	C#.
Нужно прислать ссылку на публичный репозиторий на github.com. 
...
#### Решение находится в папке task4
---

## Запуск скриптов
 Запуск Скриптов осуществляется путём передачи параметров в командную строку
```bash
python task1.py n1 m1 n2 m2
python task2.py <путь_к_файлу_эллипса.txt> <путь_к_файлу_точек.txt>
python task3.py <values.json> <tests.json> <report.json>
python task4.py data4.txt
```